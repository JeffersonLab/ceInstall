...
if ($uname eq 'Linux')
{
	...
	elsif (-e '/etc/redhat-release')
	{
		...
		elsif ($release_string =~ /^Red Hat Enterprise Linux Workstation release 6.4/) { $release = '_RHEL6.4';       }
		elsif ($release_string =~ /^Red Hat Enterprise Linux Workstation release 6.5/) { $release = '_RHEL6.5';       }
		elsif ($release_string =~ /^Red Hat Enterprise Linux Workstation release 6.6/) { $release = '_RHEL6.6';       }
		elsif ($release_string =~ /^Red Hat Enterprise Linux Workstation release 6.7/) { $release = '_RHEL6.7';       }
